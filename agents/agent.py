...
class Actor():
    ...
    def build_model(self):
      ...
      optimizer = optimizers.Adam(lr=.0002)
...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=512, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(states)
        net_states = layers.Dense(units=384, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(states)
        

        # Add hidden layer(s) for action pathway
        net_actions = layers.Dense(units=512, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(actions)
        net_actions = layers.Dense(units=384, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(actions)
        ...
        optimizer = optimizers.Adam(lr=.002)
